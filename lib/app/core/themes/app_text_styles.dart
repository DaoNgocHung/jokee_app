...
class AppTextStyles {
  static TextStyle text6 = _defaultTextStyle.copyWith(
    fontSize: 6,
  );

  static TextStyle text8 = _defaultTextStyle.copyWith(
    fontSize: 8,
  );

  static TextStyle text10 = _defaultTextStyle.copyWith(
    fontSize: 10,
  );

  static TextStyle text11 = _defaultTextStyle.copyWith(
    fontSize: 11,
  );

  static TextStyle text12 = _defaultTextStyle.copyWith(
    fontSize: 12,
  );

  static TextStyle text14 = _defaultTextStyle.copyWith(
    fontSize: 14,
  );

  static TextStyle text15 = _defaultTextStyle.copyWith(
    fontSize: 15,
  );

  static TextStyle text16 = _defaultTextStyle.copyWith(
    fontSize: 16,
  );

  static TextStyle text17 = _defaultTextStyle.copyWith(
    fontSize: 17,
  );

  static TextStyle text18 = _defaultTextStyle.copyWith(
    fontSize: 18,
  );

  static TextStyle text20 = _defaultTextStyle.copyWith(
    fontSize: 20,
  );

  static TextStyle text24 = _defaultTextStyle.copyWith(
    fontSize: 24,
  );

  static TextStyle text25 = _defaultTextStyle.copyWith(
    fontSize: 25,
  );

  static TextStyle text28 = _defaultTextStyle.copyWith(
    fontSize: 28,
  );

  static TextStyle text32 = _defaultTextStyle.copyWith(
    fontSize: 32,
  );
